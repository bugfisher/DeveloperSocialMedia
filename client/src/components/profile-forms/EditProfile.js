...
const EditProfile = props => {
    ...
    const [setSocialMediaLinks,toggleLinks] = useState(false);
    ...
    return (
      ...
      <form className="form" onSubmit={onSubmit} >
        ...
        <div className="my-2">
          <button onClick={()=>toggleLinks(!setSocialMediaLinks)} type="button" className="btn btn-light">
            Add Social Network Links
          </button>
          <span>Optional</span>
        </div>

        {setSocialMediaLinks && (<Fragment>
